...
Ara que ja estem a la pàgina d'instal·lació donar-li a descarregar la versió Ubuntu 23.10.1, això començarà la descarrega del ISO.
...
Ara ens preguntarà quanta RAM i quants processadors li posarem a aquesta màquina, segons diu la pàgina de Ubuntu, amb 4GB de RAM i 2 processador ja vas bé pero possaré 4 processadors. Una vegada acabat de possar tot el que volem li donem a "Next".
...
Ara ens pregunta quin idioma volem per a la instal·lació i també serà l'idioma de l'OS, seleccionem el que més ens agradi, en el meu cas posaré espanyol.

![Foto](/AP10-3sistema.png)

Li donem a Instalar Ubuntu.
...
![Foto](/AP16-3sistema.png)

Seleccionem tema clar o fosc, i li donem a continuar.
...
Quan s'acabi la descàrrega ens posarà que s'ha instal·lat i que cal reiniciar, així que li donem a reiniciar ara.
